    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.home) {
                    Intent activityLogIntent = new Intent(Profile.this, Homepage.class);
                    startActivity(activityLogIntent);

                }
                else if (item.getItemId() == R.id.activitylog) {
                    Intent activityLogIntent = new Intent(Profile.this, ActivityLog.class);
                    startActivity(activityLogIntent);

                }
                else if (item.getItemId() == R.id.ticket) {
                    Intent receiptIntent = new Intent(Profile.this, Ticket.class);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Profile.this, Scan.class);
